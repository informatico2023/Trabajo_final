...
# Continuar con el resto de tu código o entrenamiento del modelo
...
def get_className(classNo):
    ...
    while True:
        ...
        faces = cascada_cara.detectMultiScale(imgOriginal, 1.3, 5)
        for x,y,w,h in faces:
            ...
            probabilityValue = np.amax(prediccion)
